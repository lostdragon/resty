...
<h1>用户登陆</h1>
<div class="box">
	<p><?php echo $app_title ? '授权 <b>'.$app_title.'</b>访问你的MOMO帐号，随时与好友分享生命每一瞬间' : ''; ?> </p>
	<form name="authZForm" action="" method="post">
		...
		<div class="form_wrap clearFix" id ="inputDiv">
			...
			<div class="row_fm">
				<input type="submit" name="authorization" value="登陆"/>&nbsp;<input type="submit" name="cancel" value="取消" onclick="history.go(-1);return false;" />
			</div>
